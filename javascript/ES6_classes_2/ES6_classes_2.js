...
const cat1 = new Cat("cat", 6, "happy");
const dog1 = new Dog("doggy", 9, "happy", "Tito");
const shark1 = new Dog("sharky", 15, "happy");

console.log(dog1.greetMaster());
console.log(dog1.status);
console.log(cat1.introduce());
console.log(dog1.master);
console.log(shark1.status);
