...
terrible dive bar next door and using the referral bonus to buy, and build, the
largest three-dimensional beer can pyramid you can. And then probably drink
...
int beeramid(int bonus, double price) {
  int cans = bonus / price, l{};
	bool c_left{true};
	while (c_left) {
		cans -= l*l;
		++l;
		c_left = (cans < l*l) ? --l and false : true;
	}
	cout<< l;
  return l;
}
