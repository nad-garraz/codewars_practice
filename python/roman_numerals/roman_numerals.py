...
integer value. It should follow the API demonstrated in the examples belowself.
...
In this kata 4 should be represented as IV, NOT as IIII
...
Help
Symbol  Value
I:1 , IV:4,V:5,X:10, L: 50, C:100, D  :500, M :1000
"""
...
class RomanNumerals:
    ...
    def from_roman(roman_num):
        d = {"I": 1, "IV": 4, "V": 5, "X": 10, "L": 50, "C": 100, "D": 500,
             "M": 1000}
        a = 0
        jump = False
        for i, j in zip(roman_num, roman_num[1:]):
            if jump:
                jump = False
                continue
            if d[i] * 10 == d[j]:
