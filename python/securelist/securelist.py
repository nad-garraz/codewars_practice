...
print(messages)     # prints []
To complete this kata you need to be able to define a class
that implements __getitem__(), __str__(), __repr__(), and possibly __len__().
...
class SecureList:
    def __init__(self, lista) -> None:
        self.lista = [item for item in lista]
    ...
    def __getitem__(self, idx):
        return self.lista.pop(idx)


m = [1, 2, 3, 4, 5, 6, 7]
messages = SecureList(m)
